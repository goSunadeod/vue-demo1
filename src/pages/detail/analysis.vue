...
//        this.$http.get('/api/appData', reqParams)
//          .then((res) => {
//            this.price = res.data.data.getPrice.amount
//          })
        getAppData(reqParams).then((rst) => {
          this.price = rst.data.data.getPrice.amount
        }).catch((err) => {
          console.log(err)
        })
      },
...
//        this.$http.get('/api/appData', reqParams)
//          .then((res) => {
//            this.orderId = res.data.data.createOrder.orderId
...
//          })
        getAppData(reqParams).then((rst) => {
          this.orderId = rst.data.data.createOrder.orderId
            this.isShowCheckOrder = true
            this.isShowPayDialog = false
        }).catch((err) => {
            this.isShowErrDialog = true
